...
var CazariService = (function () {
    function CazariService(apiService) {
        this.apiService = apiService;
    }
    CazariService.prototype.testDorm = function (i) {
        this.apiService.get($('#dorm-url').text()).then(function (result) {
            console.log(result);
        });
    };
    CazariService.prototype.createDorm = function (i) {
    ...
    CazariService.prototype.seedGroundFloor = function () {
    ...
    CazariService.prototype.seedFloor1 = function () {
    ...
    CazariService.prototype.seedFloor2 = function () {
    ...
    CazariService.prototype.seedFloor3 = function () {
    ...
    CazariService.prototype.seedFloor4 = function () {
    ...
    CazariService.prototype.seedFloor5 = function () {
    ...
    CazariService = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [api_service_1.ApiService])
    ], CazariService);
    return CazariService;
}());
exports.CazariService = CazariService;
//# sourceMappingURL=cazari.service.js.map